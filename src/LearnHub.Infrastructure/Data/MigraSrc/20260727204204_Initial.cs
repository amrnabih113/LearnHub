        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedCourseIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponDiscountValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CouponCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    AppliedCoupon_ExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrialOffers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIncludedInSubscription = table.Column<bool>(type: "bit", nullable: false),
                    RequiredSubscriptionTier = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScorePercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GradeScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GradeTotalScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GradePercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GradePassed = table.Column<bool>(type: "bit", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubtitleTracks_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorReviews_InstructorId_StudentId_CourseId",
                table: "InstructorReviews",
                columns: new[] { "InstructorId", "StudentId", "CourseId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_Tier_BillingCycle",
                table: "SubscriptionPlans",
                columns: new[] { "Tier", "BillingCycle" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubtitleTracks_LessonId",
